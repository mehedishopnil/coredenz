    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          <p className="text-gray-500 mb-4">Product not found or data missing.</p>
          <button 
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex-1 border border-indigo-600 text-indigo-600 hover:bg-indigo-50 py-3 px-6 rounded-lg font-medium">
                Buy Now
              </button>
            </div>
          </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">Detailed Specifications</h3>
          </div>
