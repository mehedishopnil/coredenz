...
const WebDevLandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            ...
            <section className="max-w-4xl mx-auto px-4 py-12 bg-white rounded-xl shadow-md mb-16">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Hi, this is <span className='bg-yellow-200 px-2 rounded'>Mehedi</span> from <span className='bg-yellow-200 px-2 rounded'>Fiverr</span></h2>
                
                <div className='grid grid-cols-3 gap-2'>
                    <div className="col-span-2 prose prose-lg mx-auto border p-2">
                    
                    <div className="space-y-4 text-gray-700">
                        <p>Hi Dear,</p>
                        
                        <p>This is Mehedi — you already know me from Fiverr. I really enjoy working with you and would love to continue our collaboration.</p>
                        
                        <p>I just wanted to share something with you honestly. Fiverr takes 20% from every payment. They also charge extra fees from your side. So both of us are losing a good amount just for using the platform — even for basic communication and file delivery.</p>
                        
                        <p>For example, if I work on a $2000 project, Fiverr takes $400. As I fully depend on my development work for income, this becomes a big loss for me. I hope you understand my situation.</p>
                        
                        <p>If you're comfortable, we can continue working together through WhatsApp, Email, or any other platform you prefer. You don't need to worry about payment — we'll use a secure method with proper invoices or receipts for every transaction.</p>
                        
                        <p>Let's continue our work smoothly, without paying extra fees to any third party. Thank you so much for your understanding and support.</p>
                        
                        <p className="font-medium">Looking forward to working with you again!</p>
            ...
            <section className="max-w-6xl mx-auto px-4 py-12">
                <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">How Would You Like To Connect?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow text-center">
                        ...
                        <p className="text-gray-600 mb-6">Instant messaging for quick communication</p>
                        <button 
                            onClick={handleWhatsAppClick}
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow text-center">
                        ...
                        <p className="text-gray-600 mb-6">For detailed project discussions</p>
                        <button 
                            onClick={handleEmailClick}
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow text-center">
                        ...
                        <p className="text-gray-600 mb-6">For immediate voice communication</p>
                        <a 
            ...
            <section className="max-w-4xl mx-auto px-4 py-8 text-center mb-16">
                <div className="bg-white p-8 rounded-xl shadow-md">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Need to see the service packages?</h2>
                    <p className="text-gray-600 mb-6">Check out my professional Web Development offerings</p>
                    <Link 
